...
/**
 * Invoice Settings Seeder
 *
 * Seeds default invoice templates and settings for the application.
 * Creates three default templates: A4 Size Normal Invoice, 58mm Thermal, and 80mm Thermal.
 *
...
class InvoiceSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $templates = [
            ['name' => 'A4 Size Normal Invoice', 'size' => 'a4', 'is_default' => 1],
            ['name' => '58mm Thermal Invoice', 'size' => '58mm', 'is_default' => 0],
            ['name' => '80mm Thermal Invoice', 'size' => '80mm', 'is_default' => 0],
        ];
