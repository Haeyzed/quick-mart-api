 ...
 * Class RolesImport
 *
 * Handles the logic for importing role records from an uploaded Excel or CSV file.
...
{
    /**
     * Map a row from the spreadsheet to a Role model.
    ...
    public function rules(): array
    {
        return [
            /**
             * Validate that the role name is present.
             */
