 ...
 *
 * Handles the logic for exporting department records to Excel or PDF.
...
class DepartmentsExport implements FromQuery, WithHeadings, WithMapping
{
    ...
    /**
     * DepartmentsExport constructor.
     *
     * @param array<int> $ids Array of specific department IDs to export.
    ...
    /**
     * Map each department record to a row in the exported file.
     *
