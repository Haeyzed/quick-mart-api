 ...
 * @property-read Designation|null $newDesignation
 * @property-read User|null $reviewer
 * @method static Builder<static>|PerformanceReview whereCreatedAt($value)
 * @method static Builder<static>|PerformanceReview whereEmployeeId($value)
 * @method static Builder<static>|PerformanceReview whereId($value)
 * @method static Builder<static>|PerformanceReview whereNewDesignationId($value)
 * @method static Builder<static>|PerformanceReview whereNotes($value)
 * @method static Builder<static>|PerformanceReview whereOverallRating($value)
 * @method static Builder<static>|PerformanceReview wherePromotionEffectiveDate($value)
 * @method static Builder<static>|PerformanceReview whereReviewPeriodEnd($value)
 * @method static Builder<static>|PerformanceReview whereReviewPeriodStart($value)
 * @method static Builder<static>|PerformanceReview whereReviewerId($value)
 * @method static Builder<static>|PerformanceReview whereStatus($value)
 * @method static Builder<static>|PerformanceReview whereSubmittedAt($value)
 * @method static Builder<static>|PerformanceReview whereUpdatedAt($value)
 * @mixin Eloquent
 */
