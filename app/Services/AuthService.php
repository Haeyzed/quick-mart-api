...
class AuthService
{
     ...
     *
     * @throws ValidationException When email is already verified or mail settings are missing.
     */
     ...
     *
     * @throws ValidationException When user not found or mail settings missing.
     */
     ...
     *
     * @throws ValidationException When token is invalid or reset fails.
     */
     ...
     *
     * @throws ValidationException When already verified, hash invalid, or verification fails.
     */
     ...
     *
     * @throws ValidationException When password is incorrect.
     */
