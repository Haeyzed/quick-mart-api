...
class UpdateProductRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'profit_margin_type' => ['nullable', 'string', Rule::in(['percentage', 'fixed'])],
            ...
            'prev_img' => ['nullable', 'array'], // Previous image names (strings)
            ...
            'warranty_type' => ['nullable', 'string', 'required_with:warranty'],
            'guarantee' => ['nullable', 'integer', 'min:0'],
            'guarantee_type' => ['nullable', 'string', 'required_with:guarantee'],
            
            // Ecommerce fields
            'products' => ['nullable', 'string'], // Related products as comma-separated string
            ...
            'extras' => ['nullable', 'string'], // Extras as comma-separated string
    ...
    protected function prepareForValidation(): void
    {
        ...
        $booleanFields = [
            ...
            'is_recipe', 'is_embeded', 'is_sync_disable', 'track_inventory'
        ];
