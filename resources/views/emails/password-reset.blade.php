                      ...
                      <tbody>
                        <tr>
                          <td>
                              ...
                              <tbody>
                                <tr>
                                  <td align="center">
                                    <a
                                      href="{{ $resetUrl }}"
                                      style="background-color:#73BC1C;color:#ffffff;text-decoration:none;padding:12px 32px;border-radius:6px;font-weight:600;display:inline-block;font-size:15px"
                                      target="_blank"
                                      >Reset Password</a
                                    >
                                  </td>
                            ...
                            <p
                              style="font-size:14px;line-height:20px;color:#8898aa;margin-bottom:16px;text-align:left;margin-top:16px">
                              If the button doesn't work, copy and paste this link into your browser:
                            </p>
                            <p
                              style="font-size:12px;line-height:18px;color:#8898aa;margin-bottom:16px;text-align:left;word-break:break-all">
                              {{ $resetUrl }}
                            </p>
                            <p
                              style="font-size:15px;line-height:24px;color:#525f7f;margin-bottom:16px;text-align:left;margin-top:16px">
                              This password reset link will expire in 60 minutes. If you did not request a password reset, please ignore this email and no changes will be made to your account.
                            </p>
