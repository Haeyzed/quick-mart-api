                        ...
                        <tr>
                          <td>
                            ...
                            <p
                              ...
                              Your {{ strtolower($type) }} export is ready! Please find the attached file below.
                            </p>
                            <table
                              align="center"
                              width="100%"
                            ...
                            <p
                              style="font-size:15px;line-height:24px;color:#525f7f;margin-bottom:16px;text-align:left;margin-top:16px">
                              The export file is attached to this email. You can download and open it using your preferred application.
                            </p>
