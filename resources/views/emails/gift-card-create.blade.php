                        ...
                        <tr>
                          <td>
                            ...
                            <p
                              ...
                              A GiftCard has been successfully created for you. Please find the details below:
                            </p>
                            <table
                              align="center"
                              width="100%"
                                  ...
                                  <td>
                                    ...
                                    <div
                                      ...
                                      ><span
                                        ...
                                        >{{ number_format($giftCard->amount, 2) }} {{ $generalSetting?->currency ?? 'USD' }}</span
                                      >
                                    </div>
                            ...
                            <p
                              style="font-size:15px;line-height:24px;color:#525f7f;margin-bottom:16px;text-align:left;margin-top:16px">
                              This email was sent to you because a gift card has been created for your account. If you did not expect this gift card, please contact us immediately.
                            </p>
