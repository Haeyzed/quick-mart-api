                ...
                <tr style="width:100%">
                  <td>
                    ...
                    <p
                      ...
                      GiftCard Recharged Successfully!
                    </p>
                    <table
                      align="center"
                      width="100%"
                        ...
                        <tr>
                          <td>
                            ...
                            <p
                              ...
                              Your gift card has been successfully recharged. Please find the details below:
                            </p>
                            <table
                              align="center"
                              width="100%"
                                  ...
                                  <td>
                                    <div
                                      ...
                                      <span
                                        ...
                                        >Card Number:</span
                                      ><span
                                        style="text-align:right;flex:0 0 55%;color:#333;font-family:monospace"
                                        >{{ $giftCard->card_no }}</span
                                      >
                                    </div>
                                    <div
                                      style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px;font-size:14px;line-height:20px">
                                      ...
                                      ><span
                                        style="text-align:right;flex:0 0 55%;color:#333;font-weight:600;color:#2b8a3e"
                                        >+{{ number_format($rechargeAmount, 2) }} {{ $generalSetting?->currency ?? 'USD' }}</span
                                      >
                                    </div>
                                    <div
                                      style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px;font-size:14px;line-height:20px">
                                      ...
                                      ><span
                                        style="text-align:right;flex:0 0 55%;color:#333;font-weight:600"
                                        >{{ number_format($giftCard->getRemainingBalance(), 2) }} {{ $generalSetting?->currency ?? 'USD' }}</span
                                      >
                                    </div>
                                    @if($giftCard->expired_date)
                                    <div
                                      style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px;font-size:14px;line-height:20px">
                                      <span
                                        style="font-weight:600;color:#555;flex:0 0 40%"
                                      ...
                                      ><span
                                        ...
                                        >{{ $giftCard->expired_date->format($dateFormat) }}</span
                                      >
                                    </div>
                                    @endif
                                    <div
                            ...
                            <p
                              style="font-size:15px;line-height:24px;color:#525f7f;margin-bottom:16px;text-align:left;margin-top:16px">
                              This email was sent to you because your gift card has been recharged. If you did not expect this recharge, please contact us immediately.
                            </p>
